...
const Leaderboard: React.FC<LeaderboardProps> = ({
  ...
  const getRankBadge = (rank: number) => {
    switch (rank) {
      case 1:
        return <Badge className="bg-gradient-to-r from-yellow-400 to-yellow-600 text-black font-bold">🥇 1st</Badge>;
      case 2:
        return <Badge className="bg-gradient-to-r from-gray-300 to-gray-500 text-black font-bold">🥈 2nd</Badge>;
      case 3:
